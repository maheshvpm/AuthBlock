...
- ( void )applicationDidEnterBackground:( UIApplication * )application
{
    ...
    // Add 'Scan Barcode' shortcut.
    icon = [UIApplicationShortcutIcon iconWithTemplateImageName:@"QR Code.png"];
    item = [[UIApplicationShortcutItem alloc] initWithType:@"Com.aspiresys.scanQRCode"
